-- Migration 003 (BIGINT version): Create stock prices tables
-- Use this version when rss_items.id is BIGINT
...
CREATE TABLE IF NOT EXISTS article_stock_snapshots (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    article_id BIGINT NOT NULL COMMENT 'Foreign key to rss_items.id (BIGINT)',
    ticker VARCHAR(20) NOT NULL,
